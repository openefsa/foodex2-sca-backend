# file used for create, train, save and test the facet model
...
df = pd.read_csv('src/data/fc_data_model.csv')
...
def create_bow(X):
    ...
    pk.dump(vectorizer, open("src/model/fc_vectorizer.pkl", "wb"))
    # words in vocabulary
